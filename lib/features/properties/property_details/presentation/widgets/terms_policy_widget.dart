...
//     with SingleTickerProviderStateMixin {
//   bool _isExpanded = false;
//   static const int _initialItemCount = 5; // عدد البنود الإفتراضي قبل التوسيع
//
//   @override
//   Widget build(BuildContext context) {
//     // نحدد اللائحة اللي راح نعرضها حسب حالة التوسيع
...
//             ),
//           ),
//           // نظهر زرّ "عرض المزيد/عرض أقل" فقط إذا اللائحة أكبر من العدد الإفتراضي
