      ...
      child: Card(
        ...
        child: Column(
          ...
          children: [
            ...
            // قسم النصوص: استخدمنا Expanded لمنع Overflow وتوزيع المساحة
            Expanded(
              child: Padding(
                padding: EdgeInsets.all(8.r),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  mainAxisAlignment: MainAxisAlignment.spaceBetween, // يضمن بقاء الموقع في الأسفل
                  children: [
                    // السطر الأول: الاسم والتقييم
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Expanded(
                          child: AutoSizeTextWidget(
                            ...
                            fontWeight: FontWeight.w500,
                            maxLines: 2,
                            minFontSize: 9, // السماح بتصغير الخط في الشاشات الصغيرة
                            textAlign: TextAlign.start,
                          ),
                        ),
                        //4.w.horizontalSpace,
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              2.w.horizontalSpace,
                              RatingBarWidget(
                                evaluation: property.rating.toDouble(),
                                length: 1,
                              ),
                            ],
                          ),
